...
import com.zrx.springbootinit.constant.FileConstant;
import com.zrx.springbootinit.exception.BusinessException;
import com.zrx.springbootinit.manager.CosManager;
import com.zrx.springbootinit.model.dto.file.UploadFileRequest;
import com.zrx.springbootinit.model.entity.User;
import com.zrx.springbootinit.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    private void validFile(MultipartFile multipartFile, FileUploadBizEnum fileUploadBizEnum) {
        ...
        if (FileUploadBizEnum.USER_AVATAR.equals(fileUploadBizEnum) || FileUploadBizEnum.USER_BLOG_IMG.equals(fileUploadBizEnum)) {
            if (fileSize > ONE_M) {
